...
class PixelateProcessor:
    @staticmethod
    def apply(tensor, pixel_size=16, noise_strength=0.2, color_shift=0.001, scan_lines=False, add_glitch=False, use_pixelate=True, use_noise=False, use_color_shift=False):
        """
