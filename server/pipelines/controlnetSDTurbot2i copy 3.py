...
class Pipeline:
    ...
    def __init__(self, args: Args, device: torch.device, torch_dtype: torch.dtype):
        # Load both ControlNet models once
        ...
        for adapter_weights in adapter_weights_sets:
            # Create pipeline with shared ControlNet models
            pipe = StableDiffusionControlNetPipeline.from_pretrained(
                base_model,
                controlnet=controlnet_depth,  # Use the shared model
                safety_checker=None,
                torch_dtype=torch_dtype,
            )
            
            # Store references to shared models
