...
class LoRACurationConfig:
    ...
    def __init__(self, lora_config_dir: str, default_curation_index=0):
        ...
        self.lora_models = {
            ...
            "garance": "loras/garance",
            "dark": "loras/dark",
            "abstract-monochrome": "loras/abstract-monochrome",
            "abstract-brokenglass-red": "loras/abstract-brokenglass-red",
            "full-body-glitch-reddish": "loras/full-body-glitch-reddish",
            "melies-bw": "loras/melies-bw",
            "melies-col": "loras/melies-col",
            "nature-water": "loras/nature-water",
            "nature-fire": "loras/nature-fire",
            "nature-smoke": "loras/nature-smoke",
            "nature-sand": "loras/nature-sand",
            "robwood": "loras/robwood",
            "sweet-vicious": "loras/sweet-vicious",
            "liquid-love": "loras/liquid-love",
            "glitch": "loras/glitch",
            "pixels-bodies": "loras/pixels_bodies.safetensors",
            "pixels-face": "loras/pixels_faces-000023.safetensors",
            "origami": "loras/origami",
            "twisted-bodies": "loras/twisted-bodies",
            "HAHACards_A2": "loras/HAHACards_A2",
            "goldworld": "loras/goldworld",
            "monoblue": "loras/monoblue",
            "psychaos": "loras/psychaos",
            "angels": "loras/angels",
            "mannequin": "loras/mannequin",
            "children": "loras/children",
            "building": "loras/building",
            ...
            "twisted-bodies-xl": "loras/twisted-bodies-xl",
            "robwood-xl": "loras/robwood-xl",
            "queepybeep-xl": "loras/queepybeep-xl",
            "queepybeep-anime-xl": "loras/queepybeep-anime-xl",
            ...
            "dwellers-input": "loras/dwellers_input",
