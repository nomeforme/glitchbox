...
cd server && source .venv/bin/activate && python main.py --pipeline img2imgStreamDiffusionXL --taesd --use-upscaler --use-lora-sound-control "$@"  #--torch-compile #--onediff #--sfast #--compel #--torch-compile #--sfast
