...
cd server && source .venv/bin/activate && python main.py --pipeline img2imgStreamDiffusionXL --taesd --use-upscaler --default-curation-index 28  #--torch-compile #--onediff #--sfast #--compel #--torch-compile #--sfast
